...
+ (NSDictionary * __nonnull)mappings;
+ (NSString * __nonnull)keyForRemoteKey:(NSString * __nonnull)remote context:(NSManagedObjectContext * __nonnull)context;
...
+ (NSManagedObject * __nonnull)create:(NSDictionary * __nonnull)properties context:(NSManagedObjectContext * __nonnull)context;
- (void)update:(NSDictionary * __nonnull)properties;
- (BOOL)save;
- (void)delete;
+ (void)deleteAll;
+ (void)deleteAll:(NSManagedObjectContext * __nonnull)context;
+ (NSString * __nonnull)entityName;
@end


@interface NSManagedObjectContext (SWIFT_EXTENSION(SwiftRecord))
+ (NSManagedObjectContext * __nonnull)defaultContext;
@end


@interface NSObject (SWIFT_EXTENSION(SwiftRecord))
@end
